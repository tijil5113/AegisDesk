/**
 * Parallax Desktop Controller — mousemove passive + throttled (200ms); rAF loop ~30fps.
 * Writes --parallax-x/y and cursor --mouse-x/y to documentElement; disabled when
 * prefers-reduced-motion or low cores/memory. See PERF_AUDIT.md.
 */
class ParallaxController {
    constructor() {
        ...
        this.lastUpdate = 0;
        this.throttleDelay = 32; // ~30fps max update rate
        this.mouseMoveThrottle = null;
        this.lastMouseMove = 0;
        this.mouseMoveDelay = 200; // Throttle cursor glow + parallax to 5 updates/sec
    }
