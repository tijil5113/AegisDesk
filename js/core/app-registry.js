...
const APP_REGISTRY = {
    ...
    'terminal': {
        ...
        open: function() {
            try {
                if (typeof terminalApp !== 'undefined' && terminalApp.open) {
                    terminalApp.open();
                } else {
    ...
    'system-monitor': {
        ...
        open: function() {
            if (typeof systemMonitorApp !== 'undefined' && systemMonitorApp) {
                systemMonitorApp.open();
            } else if (typeof window !== 'undefined' && window.systemMonitorApp) {
                window.systemMonitorApp.open();
            } else {
                console.error('System Monitor app not loaded. Make sure system-monitor.js is included.');
                alert('System Monitor is not available. Please refresh the page.');
            }
        }
    },
    'gallery': {
        ...
        open: function() {
            if (typeof galleryApp !== 'undefined' && galleryApp) {
                galleryApp.open();
            } else if (typeof window !== 'undefined' && window.galleryApp) {
                window.galleryApp.open();
            } else {
                console.error('Photo Gallery app not loaded. Make sure gallery.js is included.');
                alert('Photo Gallery is not available. Please refresh the page.');
            }
        }
    },
    'playground': {
