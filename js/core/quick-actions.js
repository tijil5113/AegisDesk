    ...
    createPanel() {
        ...
        this.panel.innerHTML = `
            ...
            <div class="quick-actions-grid">
                ...
                <div class="quick-action-item" data-action="performance-mode">
                    <div class="quick-action-icon">⚡</div>
                    <div class="quick-action-label">Performance mode</div>
                </div>
            </div>
        `;
        ...
        switch(action) {
            ...
            case 'performance-mode':
                if (typeof performanceManager !== 'undefined') {
                    const on = performanceManager.togglePerformanceMode();
                    if (typeof notificationSystem !== 'undefined') {
                        notificationSystem.info('Performance', on ? 'Performance mode on — fewer animations and no blur.' : 'Performance mode off.');
                    }
                }
                break;
        }
