...
class DesktopIconCarousel {
    ...
    init() {
        ...
        /* Horizontal auto-scroll disabled: icons stay static for a calmer, OS-like launcher */
    ...
    startAutoScroll() {
        ...
        setTimeout(() => {
            ...
            // Smooth horizontal scroll: average speed, no shaking (rounded position + steady step)
            const scrollSpeedPxPerSec = 42;
            ...
            const autoScroll = (currentTime) => {
                ...
                const step = scrollSpeedPxPerSec * deltaTime;
                currentScroll = this.track.scrollLeft;
                let nextScroll = currentScroll + step;
                
                if (nextScroll >= trackWidth - 10) {
                    nextScroll = nextScroll - trackWidth;
                }
                // Round to integer to avoid subpixel jitter/shaking
                this.track.scrollLeft = Math.round(nextScroll);
